...
`failOnIncomplete` and `failOnEmptyTestSuite`: warnings, risky tests (no
assertion) and skipped tests all **fail** the run. A test that checks nothing
protects nothing.
